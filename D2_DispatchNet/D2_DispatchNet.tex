...
\newcommand\imgins[1]{{\centering\includepdf[pages=-, linktodoc, width=\textwidth]{#1}Alternate link at our \href{https://github.com/DispatchNet/TRE/blob/uc/D2_DispatchNet/#1}{Github}}} %Remember to switch away from "uc" to "main" when the merge happens
...
\imgins{activity_diagrams/UC01_activity.pdf}
