...
\newcommand\uclnk[4]{\newpage\subsubsection{#1} #4 \includepdf[pages={#2}, linktodoc=true]{use_cases/use_cases_v0.4.pdf}\imgarg{activity_diagrams/UC#3_activity.pdf}{0.6} \imgarg{sequence_diagrams/UC#3_sequence.pdf}{1}}
...
Unfortunately, the PDF merging process seems to inevitably break links. If you wish to see the up-to-date un-merged file, it is hosted on our group's \href{https://github.com/DispatchNet/TRE/blob/uc/D1_DispatchNet/D1_DispatchNet.pdf}{Github} %TODO fix here too uc to main

\includepdf[pages=-]{../D1_DispatchNet/D1_DispatchNet.pdf} %Fix the links being broken, try PAX?
