...
\textcolor{teal}{The classes descriptions have been moved from the diagram}
...
(in the following \textless Template\textgreater is a shortcut for Station, Junction or Line, used just for a short description)\\
 
viewNetwork(): view the network graph UC16\\
create\textless Template\textgreater (): create a new \textless Template\textgreater  UC20, 21, 22\\
edit\textless Template\textgreater (\textless Template\textgreater ): modify \textless Template\textgreater data UC23, 24, 25\\
delete\textless Template\textgreater(\textless Template\textgreater): remove a \textless Template\textgreater from the network UC26, 27 28\\
...
who directly uses the train services\\
...
\bf{StationData}: Used to represent a station's data that may exist at a Junction (a Station is a Junction), It's constructor implements UC17, 20\\
